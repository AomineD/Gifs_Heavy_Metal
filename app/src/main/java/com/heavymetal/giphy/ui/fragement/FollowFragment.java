...
public class FollowFragment extends Fragment {
    ...
    public void initView(){
        ...
        this.swipe_refreshl_follow_fragment.setProgressViewOffset(false,0,300);
        ...
        this.peekAndPop = new PeekAndPop.Builder(getActivity())
                ...
                .build();
        gifAdapter =new GifAdapter(gifList,null,getActivity(),peekAndPop);
        recycle_view_follow_fragment.setHasFixedSize(true);
        recycle_view_follow_fragment.setAdapter(gifAdapter);
    ...
    private void loadNextStatus() {
        ...
        Call<List<Gif>> call = service.followImage(page,language,id_user);
